...
const initialUserDetailsList = [
  {
    ...
    __v: 0,
    recruiter: {
      _id: "64c8ee122d4ed319fc6a3e6b",
      userId: "64c8ee122d4ed319fc6a3e69",
      companyname: "satiety solutions",
    },
  },
  {
    ...
    cities: ["Hyderabad", "Bangalore Rural"],
    jobType: "Full Time",
    country: "India",
    education: "B.Tech",
    salary: "7-10 LPA",
  ...
  },
  {
    ...
    deadline: "2023-08-27T00:00:00.000Z",
    skillsets: ["Manual Testing", "Automation Testing"],
    cities: ["Hyderabad"],
    jobType: "Full Time",
    country: "India",
    education: "B.Tech",
  ...
  },
  {
    ...
    title: "UI Designer",
    description:
      "need to be good designer with required skills and responsibilities and many more like this",
    experience: "2-5 years",
    maxPositions: 5,
    activeApplications: 0,
    acceptedCandidates: 0,
  ...
  },
  {
    ...
    description:
      "good communication skills in financial field you will get targets for this jobs",
    experience: "2-5 years",
    maxPositions: 3,
    activeApplications: 0,
    acceptedCandidates: 0,
  ...
  },
  {
    ...
    skillsets: ["Software Testing", "SAP abap", "Call Center"],
    cities: ["Visakhapatnam"],
    jobTyp: "Full Time",
    country: "India",
    education: "Degree",
    ...
    __v: 0,
    recruiter: {
      _id: "64c9f3a3488eecdb24e9ce87",
      userId: "64c9f3a2488eecdb24e9ce85",
      companyname: "Reddy Mounika",
    },
  },
  {
    ...
    __v: 0,
    recruiter: {
      _id: "64c9f4e0488eecdb24e9ce9c",
      userId: "64c9f4df488eecdb24e9ce9a",
      companyname: "ramaraju",
    },
  },
  {
    ...
    skillsets: ["Manual Testing", "Java"],
    cities: ["Hyderabad", "Bangalore Urban"],
    jobType: "Full Time",
    country: "India",
    education: "B-tech",
    salary: "7-10 LPA",
  ...
  },
  {
    ...
    __v: 0,
    recruiter: {
      _id: "64ccdcf2ba96d109a1a77023",
      userId: "64ccdcf1ba96d109a1a77021",
      companyname: "sai latha",
    },
  },
  {
    ...
    skillsets: ["Software Testing", "Java"],
    cities: ["Hyderabad", "Bangalore Rural"],
    jobType: "Full Time",
    country: "India",
...
function Home2() {
  ...
  const filterContent = () => {
    const filtered = initialUserDetailsList.filter(
      (initialUserDetailsList) =>
        initialUserDetailsList.skillsets.some((skill) =>
          skill.toLowerCase().includes(skillsInput.toLowerCase())
        ) &&
        initialUserDetailsList.cities.some((location) =>
  ...
  const validateExprience = () => {
    const filtered1 = initialUserDetailsList.filter(
      (initialUserDetailsList) =>
        initialUserDetailsList. experience.some((job) =>
        job.experience.toLowerCase().includes(skillsInput.toLowerCase())
        ) 
 ...
 setExperience(filtered1)
    setblogslist(filtered1);
  ...
  return (
    <div>
      ...
      <div class="text-center align-items-center justify-content-center secondContainer p-4">
        ...
        <button class=" registerButton" onClick={filterContent}>
          Search
        </button>  
      </div>
            ...
            <div class="d-flex flex-row row mt-3">
              ...
              <div >
                  <button
                    ...
                    id="browseItem" value={experience}
                    onChange={(e) => setExperience(e.target.value)}
                  >
                    Experience
                  </button>
                  <ul class="dropdown-menu">
                    <li onClick={()=>{validateExprience("0-2 years")}}>
                   
                     0-2 years
                      
                    </li>
                    <li onClick={()=>{validateExprience("2-5 years")}}>
                    
                  2-5 years
                    
                    </li>
                    <li onClick={()=>{validateExprience("5-7 years")}}>
                    5-7 years
                     </li>
...
<div>
        ...
        (
          ...
          <img src="https://img.freepik.com/free-vector/no-data-concept-illustration_114360-536.jpg?size=626&ext=jpg&ga=GA1.2.1103244850.1688422723&semt=ais" className="w-25"/>
          </div>
        )
        }
        <div class="row">
