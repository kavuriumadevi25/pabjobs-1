    ...
    <div>
      ...
      <div class="col-md-6 card p-4 allJobsContainer">
        <div class="d-flex flex row ">
          ...
          <div>
            <button className="btn14">Writing</button>
            <button  className="btn14">Dance Master</button>
            <button  className="btn14">Teaching</button>
            <button  className="btn14">Cooking</button>
            <button  className="btn14">Photography</button>
            <button  className="btn14">Video Making</button>
            <button  className="btn14">Designing</button>
            <button  className="btn14">Graphics</button>
            <button  className="btn14">Painting</button>
            <button className="btn14">Designing</button>
            <button className="btn14">Writing</button>
            <button  className="btn14">Dance Master</button>
            <button  className="btn14">Teaching</button>
