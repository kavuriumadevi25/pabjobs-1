    ...
    <div>
      ...
      <div class="col-md-6 card p-4 allJobsContainer">
        <div class="d-flex flex row ">
          ...
          <div>
            <button className="btn14">ABAP Consultant</button>
            <button  className="btn14">BPO Executive</button>
            <button  className="btn14">Chef</button>
            <button  className="btn14">Editor</button>
            <button  className="btn14">Finance Manager</button>
            <button  className="btn14">Game Designer</button>
            <button  className="btn14">HR Assistant</button>
            <button  className="btn14">Industrial Enginerr</button>
            <button  className="btn14">Java Developer</button>
            <button className="btn14">ABAP Consultant</button>
            <button  className="btn14">BPO Executive</button>
            <button  className="btn14">Chef</button>
            <button  className="btn14">Editor</button>
