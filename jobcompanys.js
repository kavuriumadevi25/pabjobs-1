    ...
    <div>
      ...
      <div class="col-md-6 card p-4 allJobsContainer">
        <div class="d-flex flex row ">
          ...
          <div>
            <button className="btn14">Aman Tech</button>
            <button  className="btn14">Bata</button>
            <button  className="btn14">Amazon</button>
            <button  className="btn14">Binomo</button>
            <button  className="btn14">coal India</button>
            <button  className="btn14">Aurbindo</button>
            <button  className="btn14">Britania</button>
            <button  className="btn14">Cipla</button>
            <button  className="btn14">HCL</button>
            <button className="btn14">PerfexTechnologie</button>
            <button className="btn14">Aman Tech</button>
            <button  className="btn14">Bata</button>
            <button  className="btn14">Amazon</button>
            <button  className="btn14">Binomo</button>
