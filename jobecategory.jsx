    ...
    <div>
      ...
      <div class="col-md-6 card p-4 allJobsContainer">
        <div class="d-flex flex row ">
          ...
          <div>
            <button className="btn14">Airline</button>
            <button  className="btn14">Advertising</button>
            <button  className="btn14">Analytics</button>
            <button  className="btn14">Banking</button>
            <button  className="btn14">Bpo</button>
            <button  className="btn14">Content Writing</button>
            <button  className="btn14">E Commerce</button>
            <button  className="btn14" style={{width:"160px"}}>System Programing</button>
            <button  className="btn14">Network Design</button>
            <button className="btn14">Airline</button>
            <button  className="btn14">Advertising</button>
            <button  className="btn14">Analytics</button>
            <button  className="btn14">Banking</button>
